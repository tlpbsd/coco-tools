...
4 RETURN
10 MX=6:CLS
20 PRINT@200,"escape from mars"
25 PRINT@259,"BY AARDVARK LTD. SOFTWARE":PRINT@355,"MC-10 EDITS BY JIM GERRIE":FORQ=1TO2500:NEXTQ:CLS
100 DIMD$(18):DIMO$(54):DIML(248):DIMP(18,20):L=1:L2=1
110 FORX=1TO18:READD$(X):NEXTX
...
200 NEXTX:DATANORTH,SOUTH,EAST,WEST,UP,DOWN
210 DATANETS,2,FASTGRO,20,HOLY GRAIL,5,SEEDS,20
220 DATAALCOHOL,20,BRASS TUBING,13,STATUE OF FLUTE PLAYER,3
...
460 IFL=12THENFORX=1TO6:P(12,X)=0:NEXTX:P(12,INT(2*RND(0))+1)=13
...
630 IFL(16)=20THENIFRND(0)>.95THENPRINT"I AM BEING WATCHED":FORZZ=1TO500:NEXTZZ
...
660 NEXTX:FORX=1TOLEN(O$)STEP2:IFMID$(O$,X,2)=B$THENS=(X+1)/2
670 NEXTX:IFA$="IN"THEN1030
...
780 A$="I SEE: ":FORX=1TO47:IFLEN(A$)>223THENM$=LEFT$(A$,LEN(A$)-2):GOSUB1:A$=""
785 IFL(X)=L2 THENA$=A$+O$(X+6)+", ":Y=Y+1
790 NEXTX:IFY=0THENM$=A$+"NOTHING":GOSUB1:GOTO800
795 M$=LEFT$(A$,LEN(A$)-2):GOSUB1
800 PRINT:M$="OBVIOUS EXITS ARE":FORX=1TO6:IFP(L,X)>0THENM$=M$+" * "+O$(X)
...
860 IFC>MX THENPRINT"CAN'T. I'M CARRYING TOO MUCH":GOTO460
870 IFS>37ORS=31THENPRINT"I CAN'T TAKE THAT":GOTO460
...
910 PRINT"SIGN FELL":L(28)=-1:L(27)=0:C=C+1:GOTO460
920 M$="IT'S TIED TO A LEDGE ON THE SECOND FLOOR":GOSUB1:GOTO460
930 L(29)=0:C=C+1:IFL=8THENPRINT"AHA!":L(25)=8:GOTO460
...
1090 M$="I SEE A RUGGED PERSON IN A POCKETED SURVIVAL SUIT":GOSUB1:GOTO500
1100 IFS=54ANDL(11)=20THENPRINT"A HARMONICA AND A LIGHTER":L(11)=0:L(12)=0:C=C+2:MX=MX+2:GOTO460
1120 IFS=4ANDL=6THENPRINT"THERE IS SOMETHING THERE":GOTO460
1130 IFS=34ANDL=5ANDL(28)<>-1THENPRINT"EARTHY GO HOME!!":GOTO460
1140 IFS=41ANDL=3THENL2=18:GOTO780
1150 IFS=52ANDL=1THENL2=3:GOTO780
1160 IFS=9THENPRINT"SEEDS!":L(4)=L:GOTO460
1180 IFS=29THENM$="SUGGESTED FUELS: HYDRAZINE OR ALCOHOL":GOSUB1:GOTO460
...
1255 IFB$="HE"ANDL(30)=0THENL(30)=L:C=C-1
...
1400 IFA$="FI"ORA$="HA"ORA$="FO"ORA$="AR"THENPRINT"YOU'RE KIDDING!":GOTO460
...
1480 NEXTX:GOTO460
1490 IFS<>33ORL(33-6)<>0THEN1520
1500 INPUT"TO WHAT";A$:GOSUB1660
1510 IFA$="ST"THENR=1:P(6,6)=7:P(7,5)=6:L(S-6)=-1:C=C-1:GOTO460
...
1760 PRINT"YOU HAVE ESCAPED FROM MARS!":END
1800 IFL=1THENPRINT"LOOK AROUND THE SHIP":GOTO460
1810 IFL=8THENPRINT"NOT ALL EXITS ARE OBVIOUS":GOTO460
1815 IFL=3THENPRINT"LOOKS LIKE MARTIANS LIKE MUSIC":GOTO460
1820 IFL(15)=20THENPRINT"WHAT'S THAT RUSTLING SOUND?":GOTO460
1830 M$="WHY ASK ME FOR HELP--IT'S YOUR ADVENTURE":GOSUB1:GOTO460
2000 FORZZ=1TO13:PRINT:SOUNDZZ,1:NEXTZZ
...
2540 PRINT"      !!!!!!!!!!!!!!!!!!!":SOUND57,1:FORZZ=58TO92:PRINT:SOUNDZZ,1:NEXTZZ
2550 RETURN
